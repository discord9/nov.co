...
//Tweak by discord9,set to target fighter only,also enabled failsafe.
...
public class AntiFighterMissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    */
    ...
    private final int frigates=0;
    private final int destroyers=0;
    private final int cruisers=0;
    ...
    public AntiFighterMissileAI(MissileAPI missile, ShipAPI launchingShip) {
